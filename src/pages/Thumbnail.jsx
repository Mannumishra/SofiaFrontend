...
function TibialNail() {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get(`https://api.sofia.digiindiasolutions.com/api/single-inplants-product-by-name/${name}`);
                ...
                <div className="container-fluid ThumbnailSection" style={{ background: 'linear-gradient(175deg, #CEE5FD 0%, #FFFFFF 100%)' }}>
                    <div className="row px-3 px-md-5">
                        <div className="col-12 col-md-6 text-center mb-4 mb-md-0">
                            <img
                                src={`https://api.sofia.digiindiasolutions.com/${image}`}
                                alt="Product View"
                    ...
                    <Modal show={showModal} onHide={handleCloseModal} centered>
                        ...
                        <Modal.Body>
                            <img src={`https://api.sofia.digiindiasolutions.com/${image}`} alt="Product View" className="img-fluid" />
                        </Modal.Body>
                    </Modal>
